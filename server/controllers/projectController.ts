...
// controller function to make revisions
...
Return ONLY the enhanced request, nothing else. Keep it concise (1-2 sentences).`,
    ...
    const codeGenerationResponse = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Here is the curent website code: "${currentProject.current_code}". The user wants this change:"${enhancedPrompt}"`,
        },
      ],
    });
...
// Controller Function to roll back to the previous version
...
// Controller funtion to delete a project
...
// Controller funtion for getting project code for preview
...
//Controller for get published projects
