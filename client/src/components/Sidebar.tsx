  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        {/* message container */}
        <div className="flex-1 overflow-y-auto noscrollbar px-3 flex flex-col gap-4">
          {[...project.conversation, ...project.versions]
            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                return (
                  <div
                    className={`flex items-start ga3 ${
                ...
                return (
                  <div
                    key={ver.id}
                    className="w-4/5  mx-aut0 my-2 p-3 rounded-xl bg-gray-800 text-gray-100 shadow flex flex-col gap-2"
                  >
                    ...
                    <div className="flex items-center justify-between">
                      {project.current_version_index === ver.id ? (
                        ...
                        <button
                          ...
                          className="px-3 py-1 rounded-md text-xs bg-indigo-500 hover:bg-indigo-500 text-white"
                        >
        ...
        {/* input area */}
        <form action="" className="m-3 relative" onSubmit={handleRevisions}>
