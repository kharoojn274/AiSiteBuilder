...
const Projects = () => {
  ...
  return project ? (
    <div className="flex flex-col h-screen w-full  bg-gray-900 text-white">
      ...
      <div className="flex max-sm:flex-col sm:items-center gap-4 p-4 no-scrollbar">
        {/* left */}
        ...
        <div className="flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm">
          <button
            onClick={saveProject}
            disabled={isSaving}
            className="max-sm:hidden bg-gray-800 hover:bg-gray-700 text-white
          px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors border border-gray-700"
          >
            {isSaving ? (
          ...
          <button
            ...
            className="bg-linear-to-br from-blue-700 to-blue-600
          ...
          <button
            ...
            className="bg-linear-to-br from-indigo-700  to-indigo-600 
          hover:from-indigo-600 hover:to-indigo-500 text-white 
      ...
      {/* content */}
      <div className="flex1 flex overflow-auto ">
        <Sidebar
