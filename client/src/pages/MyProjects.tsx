            ...
            <div className="flex flex-wrap gap-3.5">
              {projects.map((project) => (
                <div
                  ...
                  key={project.id}
                  className="relative group w-72 max-sm:mx-auto 
                  cursor-pointer bg-gray-900/60 border border-gray-700 
                  rounded-lg overflow-hidden shadow-md group hover:shadow-indigo-700/30
                   hover:border-indigo-800/80 transition-all duration-300"
                >
                  {/* desktop like mini preview */}
                  <div
                    className="relatvie w-full h-40 bg-gray-900 overflow-hidden 
                  ...
                  {/* content */}
                  <div
                    className="p-4 text-white bglin-180 from-transparent group-hover:from-indigo-950
                  ...
                  >
                    <div className="flex items-start justify-between mt-9">
                      ...
                      <button
                        className="px-2.5 py-0.5 mt-1 ml-2 text-xs bg-gray-800 border
                  ...
                  <div onClick={(e) => e.stopPropagation()}>
                    ...
                    bg-white p-1.5 size-7 rounded text-rose-500 text-xl cursor-pointer transition-all"
